...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\Pupuk\Backend\public\storage' => 'string',
            'jwt.secret' => 'string',
            ...
            'services.telegram.admin_chat_id' => 'string',
...
'cloudinary.upload_preset','cloudinary.upload_route','cloudinary.upload_action','cloudinary.cloud.cloud_name','cloudinary.cloud.api_key',
'cloudinary.cloud.api_secret','cloudinary.url.secure','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.cloudinary.driver',
'filesystems.disks.cloudinary.cloud','filesystems.disks.cloudinary.key','filesystems.disks.cloudinary.secret','filesystems.links.C:\\laragon\\www\\Pupuk\\Backend\\public\\storage','jwt.secret',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.telegram.bot_token','services.telegram.admin_chat_id',
...
'filament.livewire_loading_delay','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'filament.admin.pages.dashboard','filament.admin.resources.kategori-pupuks.index','filament.admin.resources.kategori-pupuks.create','filament.admin.resources.kategori-pupuks.edit','filament.admin.resources.pesanans.index',
'filament.admin.resources.pesanans.create','filament.admin.resources.pesanans.view','filament.admin.resources.pesanans.edit','filament.admin.resources.pupuks.index','filament.admin.resources.pupuks.create',
'filament.admin.resources.pupuks.edit','filament.admin.resources.users.index','filament.admin.resources.users.create','filament.admin.resources.users.edit','livewire.update','livewire.upload-file','livewire.preview-file','api.kategori.index',
'api.pupuk.index','api.pupuk.show','api.register','api.login','api.logout',
'api.user','user.photo.update','pesanan.index','pesanan.store','pesanan.show',
'pesanan.update','pesanan.destroy','api.pesanan.submitProof','api.pesanan.tandaiSelesai','keranjang.index',
'keranjang.store','keranjang.update','keranjang.destroy','pesanan.pdf',);
...
'filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','pdf.pesanan','vendor.filament-panels.components.avatar.tenant',
'vendor.filament-panels.components.avatar.user','vendor.filament-panels.components.form.actions','vendor.filament-panels.components.form.index','vendor.filament-panels.components.global-search.actions','vendor.filament-panels.components.global-search.field',
'vendor.filament-panels.components.global-search.index','vendor.filament-panels.components.global-search.no-results-message','vendor.filament-panels.components.global-search.result','vendor.filament-panels.components.global-search.result-group','vendor.filament-panels.components.global-search.results-container',
'vendor.filament-panels.components.header.index','vendor.filament-panels.components.header.simple','vendor.filament-panels.components.layout.base','vendor.filament-panels.components.layout.index','vendor.filament-panels.components.layout.simple',
'vendor.filament-panels.components.logo','vendor.filament-panels.components.page.index','vendor.filament-panels.components.page.simple','vendor.filament-panels.components.page.sub-navigation.select','vendor.filament-panels.components.page.sub-navigation.sidebar',
'vendor.filament-panels.components.page.sub-navigation.tabs','vendor.filament-panels.components.page.unsaved-data-changes-alert','vendor.filament-panels.components.resources.relation-managers','vendor.filament-panels.components.resources.tabs','vendor.filament-panels.components.sidebar.group',
'vendor.filament-panels.components.sidebar.index','vendor.filament-panels.components.sidebar.item','vendor.filament-panels.components.tenant-menu','vendor.filament-panels.components.theme-switcher.button','vendor.filament-panels.components.theme-switcher.index',
'vendor.filament-panels.components.topbar.database-notifications-trigger','vendor.filament-panels.components.topbar.index','vendor.filament-panels.components.topbar.item','vendor.filament-panels.components.unsaved-action-changes-alert','vendor.filament-panels.components.user-menu',
'vendor.filament-panels.pages.auth.edit-profile','vendor.filament-panels.pages.auth.email-verification.email-verification-prompt','vendor.filament-panels.pages.auth.login','vendor.filament-panels.pages.auth.password-reset.request-password-reset','vendor.filament-panels.pages.auth.password-reset.reset-password',
'vendor.filament-panels.pages.auth.register','vendor.filament-panels.pages.dashboard','vendor.filament-panels.pages.tenancy.edit-tenant-profile','vendor.filament-panels.pages.tenancy.register-tenant','vendor.filament-panels.resources.pages.create-record',
'vendor.filament-panels.resources.pages.edit-record','vendor.filament-panels.resources.pages.list-records','vendor.filament-panels.resources.pages.manage-related-records','vendor.filament-panels.resources.pages.view-record','vendor.filament-panels.resources.relation-manager',
'vendor.filament-panels.widgets.account-widget','vendor.filament-panels.widgets.filament-info-widget','welcome','cloudinary::components.image','cloudinary::components.video',
'cloudinary::components.widget','filament-actions::badge-action','filament-actions::badge-group','filament-actions::button-action','filament-actions::button-group',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','CLOUDINARY_CLOUD_NAME','CLOUDINARY_API_KEY',
'CLOUDINARY_API_SECRET','CLOUDINARY_URL','PIXABAY_API_KEY','TELEGRAM_BOT_TOKEN','TELEGRAM_ADMIN_CHAT_ID',
